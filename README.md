...
and Datadogs [apigentools](https://github.com/DataDog/apigentools).
...
To initially generate the JAR, execute:
...
Follow the [installation](#installation) instruction and execute the following Java code:
...
Find documentation for API endpoints and models under the [`api_docs`](/api_docs) directory. 
...
Datadog recommends creating an instance of `ApiClient` per thread in a multithreaded environment to avoid any potential issues.

## Need help?

File an issue in this repo or contact us at support@datadoghq.com.
